...
# (must have the same features as the original cluster_2.csv)
...
joblib.dump(predictor, 'cluster_2_predictor.joblib')
print("\n✓ Saved: cluster_2_predictor.joblib")

# Verify it can be loaded and used
loaded_predictor = joblib.load('cluster_2_predictor.joblib')
...
print(f"  Output: {n_components} PCA component(s)")
print(f"  Fixes: Properly handles variance filtering and selective column scaling")
