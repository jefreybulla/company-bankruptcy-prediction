"""
Custom classes for Cluster 3 predictor unpickling.

These classes are required to load the saved joblib files:
- cluster_3_predictor.joblib
- cluster_3_preprocessing_pipeline.joblib
- cluster_3_stacking_model.joblib
"""
...
class Predictor(BaseEstimator):
    ...
    Usage:
        from cluster_3_classes import Predictor
        import joblib
