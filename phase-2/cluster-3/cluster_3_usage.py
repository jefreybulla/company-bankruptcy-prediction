# %% [markdown]
# # Cluster 3 Usage: Testing the Exported Predictor
# 
# This notebook demonstrates how to load and use the combined predictor (preprocessing + model) that was exported from the Cluster 3 analysis.
# 
...
from cluster_3_classes import Predictor, PreprocessorWrapper, ColumnDropper

# Load the combined predictor
predictor = joblib.load('cluster_3_predictor.joblib')

print("✓ Cluster 3 Predictor loaded successfully")
print(f"  {predictor}")
